package thanhdoan.api_gateway.filter;
...
@Component
public class KeyAuthFilterGatewayFilterFactory
    extends AbstractGatewayFilterFactory<KeyAuthFilterGatewayFilterFactory.Config> {
